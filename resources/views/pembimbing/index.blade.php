        ...
        <div class="bg-light rounded h-100 p-4">
            ...
            @if (auth()->user()->level_id === 3 || auth()->user()->level_id === 4)
                <div class="text-end mb-2">
                    <a href="/pembimbing/create" class="btn btn-sm btn-outline-primary ">Tambah <i class="fa fa-plus"></i></a>
                </div>
            @endif
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    @if ($pembimbing->email_verified_at)
                                                        <p class="dropdown-item text-primary">{{ __('Account Verified') }}
                                                        </p>
                                                    @else
                                                        <form method="POST"
                                                            action="/email/verification-notification/{{ $pembimbing->id }}">
                                                            @csrf
                                                            <button type="submit"
